...
export function AdminHomePage() {
  ...
  const menuItems = [
    ...
    { to: `${base}/courses`, labelKey: "nav.courses" as const, icon: BookOpen, color: "purple" as const, descKey: "admin.menu.coursesDesc" as const },
    { to: `${base}/meetings`, labelKey: "nav.meetings" as const, icon: Video, color: "blue" as const, descKey: "admin.menu.meetingsDesc" as const },
